...
import '../theme/wikiform.css';

/**
 * The wiki form view controller class.
 *
 * @extends module:ui/view~View
 */
export default class WikiFormView extends View {
    ...
    _createUrlInput() {
        ...
        this._urlInputViewInfoDefault = t('عنوان را اینجا جستجو کنید');
        this._urlInputViewInfoTip = t('نکته: برای نتیجه بهتر عنوان را کلی ننویسید');

        labeledInput.label = t('Search Wiki');
        labeledInput.infoText = this._urlInputViewInfoDefault;
        inputView.placeholder = 'عنوان';
